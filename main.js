...
function revertFormatting(dateToRevert) {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(year, month, day), "yyyy-MM-dd")
}
...
function reformatDateDue(dateString) {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(year, month, day), 'MM/dd/yyyy')
}
...
function pageSelector(e) {
    ...
    if (pageSelectedTitle === `overview` || pageSelectedTitle === `done.`) {
        ...
        (0,_pageLoader_js__WEBPACK_IMPORTED_MODULE_2__.loadMainContent)(currentObjectArray.projects, null, sortedByDateTaskObjects, `due today`);
    } else if (pageSelectedTitle === `this week`) {
        const currentObjectArray = (0,_objectDataManagement_js__WEBPACK_IMPORTED_MODULE_1__.getObjectArrays)();
        const sortedByDateTaskObjects = filterDueDates(currentObjectArray.tasks, `weekly`);
        (0,_pageLoader_js__WEBPACK_IMPORTED_MODULE_2__.loadMainContent)(currentObjectArray.projects, null, sortedByDateTaskObjects, `due this week`);
    } else if (pageSelectedTitle === `past due`) {
        const currentObjectArray = (0,_objectDataManagement_js__WEBPACK_IMPORTED_MODULE_1__.getObjectArrays)();
        const sortedByDateTaskObjects = filterDueDates(currentObjectArray.tasks, `past due`);
        (0,_pageLoader_js__WEBPACK_IMPORTED_MODULE_2__.loadMainContent)(currentObjectArray.projects, null, sortedByDateTaskObjects, `past due`);
    }
}
...
function filterDueDates(arrayOfTasks, sortByType) {
    ...
    arrayOfTasks.forEach( object => {
        ...
        if (sortByType === `today`&& (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(year, month, day))) {
            sortedByDateTaskObjects.push(object);
        } else if (sortByType === `past due` && !(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(year, month, day)) && (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(new Date(year, month, day))) {
            sortedByDateTaskObjects.push(object);
        } else if (sortByType === `weekly` && (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(new Date(year, month, day))) {
            sortedByDateTaskObjects.push(object);
        }
    })
